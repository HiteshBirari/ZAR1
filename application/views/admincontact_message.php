    ...
    <h2 style="font-family: Times New Roman, Times, serif;"><b>ADMIN PANEL</b></h2>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo base_url('index.php/AdminContact')?>">Contact</a>
                </li>
                <li class="nav-item">
                            ...
                            <div class="card card-primary">
                                <div class="card-header" style="background-color:rgb(87, 82, 149);">
                                    <div style="width:50%;float:left;">
                                        <h2 class="card-title" Style="color:white;"><b>ContactUs Table</b></h2>
                                    </div>
